  ...
  return (
    <>
      <div
        ...
        onClick={() => {
          toogleMenu();
          changeColorOfActive(previousActive);
        }}
      >
        <div className="menu">
      ...
      <div className="nav">
        ...
        <div
          ...
          onClick={() => {
            dispatch(
              setCategory({ categoryPl: "losowe", categoryEn: "random" })
            );
            dispatch(changeActive(1));
            changeClass(1, previousActive);
          }}
        >
        ...
        {level >= 2 ? (
          ...
          <>
            <Tooltip
              title="Wbij 2 poziom, aby odblokować"
              placement="right"
              arrow
            >
              <div className="nav-option opacity50">
                <i className="fas fa-not-equal"></i>
              </div>
            </Tooltip>
          </>
        ...
        {level >= 3 ? (
          <div
            ...
            onClick={() => {
              dispatch(
                setCategory({ categoryPl: "zwariowane", categoryEn: "crazy" })
              );
              dispatch(changeActive(3));
              changeClass(3, previousActive);
            }}
          >
          ...
          <>
            <Tooltip
              title="Wbij 3 poziom, aby odblokować"
              placement="right"
              arrow
            >
              <div className="nav-option opacity50">
        ...
        {level >= 4 ? (
          <div
            ...
            onClick={() => {
              ...
              dispatch(changeActive(4));
              changeClass(4, previousActive);
            }}
          >
          ...
          <>
            <Tooltip
              title="Wbij 4 poziom, aby odblokować"
              placement="right"
              arrow
            >
              <div className="nav-option opacity50">
        ...
        {level >= 5 ? (
          <div
            ...
            onClick={() => {
              ...
              dispatch(changeActive(5));
              changeClass(5, previousActive);
            }}
          >
          ...
          <>
            <Tooltip
              title="Wbij 5 poziom, aby odblokować"
              placement="right"
              arrow
            >
              <div className="nav-option opacity50">
        ...
        {level >= 6 ? (
          <div
            ...
            onClick={() => {
              ...
              dispatch(changeActive(6));
              changeClass(6, previousActive);
            }}
          >
          ...
          <>
            <Tooltip
              title="Wbij 6 poziom, aby odblokować"
              placement="right"
              arrow
            >
              <div className="nav-option opacity50">
