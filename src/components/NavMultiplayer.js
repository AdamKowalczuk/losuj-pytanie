...
import { setCategory,changeActive,disableMenu,setCategoryToActive } from '../actions/index'
...
export default function Nav() {
    ...
    return (
        <>
            ...
            <div className="nav">
                <div className="menu" onClick={() => {toogleMenu();disableMenu()}}><i className="fas fa-bars"></i></div>
                <div className="nav-option" onClick={() =>{ dispatch(setCategory({categoryPl:"losowe",categoryEn:"random"}));dispatch(changeActive(1));disableMenu();dispatch(setCategoryToActive())}}><i className="fas fa-dice"></i></div>
                {level>=2 ?
                <div className="nav-option" onClick={() => {dispatch(setCategory({categoryPl:"tak czy nie",categoryEn:"yesOrNot"}));dispatch(changeActive(2));disableMenu();dispatch(setCategoryToActive())}}><i className="fas fa-not-equal"></i></div>
                ...
                {level>=3 ?
                <div className="nav-option" onClick={() => {dispatch(setCategory({categoryPl:"zwariowane",categoryEn:"crazy"}));dispatch(changeActive(3));disableMenu();dispatch(setCategoryToActive())}}><i className="fas fa-grin-tongue-wink"></i></div>
                ...
                {level>=4 ?
                <div className="nav-option" onClick={() => {dispatch(setCategory({categoryPl:"Pytania, których nikt nie zadaje",categoryEn:"aQuestionNoneAsked"}));dispatch(changeActive(4));disableMenu();dispatch(setCategoryToActive())}}><i className="fas fa-head-side-cough-slash"></i></div>
                ...
                {level>=5 ?
                <div className="nav-option" onClick={() => {dispatch(setCategory({categoryPl:"filozoficzne",categoryEn:"philosophical"}));dispatch(changeActive(5));disableMenu();dispatch(setCategoryToActive())}}><i className="fas fa-book"></i></div>
                ...
                {level>=6 ?
                <div className="nav-option" onClick={() => {dispatch(setCategory({categoryPl:"co wolisz",categoryEn:"whatDoYouPrefer"}));dispatch(changeActive(6));disableMenu();dispatch(setCategoryToActive())}}><i className="fas fa-balance-scale-left"></i></div>
